...
description: MoneyGameSurvivalGuide 책 내용을 기반으로 '경제 전문 인플루언서' 페르소나의 블로그 포스팅을 100개 규모로 기획/작성하고, 산출물을 Additionals/blog_posts 아래(outlines/drafts/final)에 저장하도록 강제할 때 사용한다.
---
